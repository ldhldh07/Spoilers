...
#g17 {
  ...
  background: -webkit-linear-gradient(to left, #727a17, #414d0b);  /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to left, #727a17, #414d0b); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
}
#g18 {
